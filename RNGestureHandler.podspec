...
# This helper class is needed to avoid function name clashing with the
# cocoapod install_dependencies function.
class RNGestureHandlerHelper
...
Pod::Spec.new do |s|
  ...
  if defined?(install_modules_dependencies()) != nil
    ...
    RNGestureHandlerHelper.install_dependencies(s, new_arch_enabled)
  end
end
